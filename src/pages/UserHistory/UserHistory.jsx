...
//     //TODO לאתר את השם הנכון של סוג השאלה לפי הID
    return(
        <div>
            ...
            <div>
                <label>
                    <input
                        ...
                        onChange={() => {
                            ...
                            setOnlyCorrectFilter(true);
                            setOnlyIncorrectFilter(true);
                        }}
                    />
                    הצג הכל
                </label>
                ...
                <label>
                    <input
                        type="radio"
                        name="answerFilter"
                        checked={!showAllFilter && onlyCorrectFilter}
                        onChange={() => {
                            setShowAllFilter(false);
                            setOnlyCorrectFilter(true);
                            setOnlyIncorrectFilter(false);
                        }}
                    />
                    רק תשובות נכונות
                </label>
                ...
                <label>
                    <input
                        type="radio"
                        name="answerFilter"
                        checked={!showAllFilter && onlyIncorrectFilter}
                        onChange={() => {
                            setShowAllFilter(false);
                            setOnlyCorrectFilter(false);
                            setOnlyIncorrectFilter(true);
                        }}
                    />
                    רק תשובות שגויות
            ...
            {/*                    <td>{history.is_correct_answer}</td>*/}
            {/*                    <td>{history.level}</td>*/}
            {/*                    <td>{history.question_type_id}</td>*/}
            {/*                    <td>{history.answer}</td>*/}
            {/*                    <td>{history.solution_time}</td>*/}
            {/*                    <td>{history.island}</td>*/}
            {/*                </tr>*/}
            {/*            );*/}
