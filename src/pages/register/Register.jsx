...
import {CHECK_OTP, EMAIL_ALREADY_EXISTS, LOGIN_URL, REGISTER_PAGE, SERVER_URL} from "../../utils/Constants.js";
...
const Register = () => {
    ...
    useEffect(() => {
        if (regData?.success) {
            ...
            if (regData?.errorCode===EMAIL_ALREADY_EXISTS){
                console.log("jkhhjgkjgkhjg ",emailAlreadyExists)
    ...
    }, [errors, formData, emailAlreadyExists]);
                ...
                <h1 className="form-title">הירשמות</h1>
                {
                    !showOtp ? (
                            <form className={"grid-container"} onSubmit={handleSubmit}>
                                <div className="form-input form-margins flex lastname-container" id={"item-1"}>
                                ...
                                <div className="form-input form-margins flex" id={"item-2"}>
                                        ...
                                        <input
                                            ...
                                            onChange={
                                                (e) => {
                                                        ...
                                                        handleChange(e);
                                                        emailAlreadyExists && setEmailAlreadyExists(false);
                                ...
                                <div className="form-input form-margins flex password-container" id={"item-6"}>
                                ...
                                <div className="form-input form-margins flex confirmPass-container" id={"item-7"}>
