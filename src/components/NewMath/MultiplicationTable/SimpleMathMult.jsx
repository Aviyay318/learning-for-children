...
export default function SimpleMathMult ({ questionType }) {
    return(
        <>
            {/*"/api/islands/Addition-and-subtraction"*/}
            <SimpleMath questionType={questionType} url={"/api/islands/multiplication-table"}/>
        </>
    )
}
