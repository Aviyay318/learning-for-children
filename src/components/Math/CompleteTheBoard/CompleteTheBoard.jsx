...
export default function CompleteTheBoard(){
    ...
    useEffect(() => {
        if(boardData!==null && boardData.length>0){
            setCurrentExercise(boardData[0])
        }
    }, [boardData]);
    ...
    function exerciseComponent () {
        ...
        return(
            <div className={"exercise-component flex"}>
                {/*<label>{currentExercise.num1}</label>*/}
                {/*<label>{currentExercise.operand1}</label>*/}
                {/*<label>{currentExercise.num2}</label>*/}
                {/*<label>{currentExercise.operandEqual}</label>*/}
                {/*<label>?</label>*/}
                <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="300"         /* Display size in pixels: width of 300px */
                    height="300"        /* Display size in pixels: height of 300px */
                    viewBox="0 0 1000 1000" /* Coordinate system still 1000×1000 internally */
                    id={"wood-sign-arrow"}
                ...
                >
                    ...
                    >
                        <text x="500" y="430" rotate={-90}>{/* 1st line */}
                            {currentExercise.num1}
                        </text>

                        <text x="500" y="530" rotate={-90}>{/* 2nd line */}
                            {currentExercise.operand1}{currentExercise.num2}
                        </text>

                        <text x="500" y="630" rotate={-90}>{/* 3rd line */}
            ...
            <div className={"complete-board"}>
                {boardData !== null ? boardData.map((exercise, index) => (
                    <div className={"board-grid"} key={index} style={{textAlign: 'center'}}>
                        <button className={"grid-item"} id={`item-${index}`}>
                            <svg
                                xmlns="http://www.w3.org/2000/svg"
                                width="80" height="80"
                                viewBox="0 0 80 80">
